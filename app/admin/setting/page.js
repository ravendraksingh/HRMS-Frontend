...
import { Building, Calendar, CalendarClock, Pin, Settings, ClipboardClock, UserRound, ShieldUser } from "lucide-react";
...
const SettingsPage = () => {
  ...
  return (
    <div className="px-5">
      <h1 className="text-3xl text-center font-bold p-5">Organization Settings</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
        {settingsSections.map((section) => {
          const Icon = section.icon;
          return (
            <Card key={section.url} className="hover:shadow-lg transition-shadow">
              <CardHeader>
