      ...
      <div className="mb-6 flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600">
            Welcome back, {user?.employee_name || user?.name || "HR Manager"}!
          </p>
        </div>
        <Button
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {stats.pendingLeaveRequests} leaves,{" "}
                  {stats.pendingAttendanceCorrections} corrections
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">Attendance Corrections</p>
                    <p className="text-sm text-gray-500">
                      {stats.pendingAttendanceCorrections} pending review
                    </p>
                  </div>
                </div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">Employees on leave</p>
              </div>
